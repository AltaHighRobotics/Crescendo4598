...
public class RunIntakeBackwardsCommand extends Command {
  private ShooterAndIntakeSub m_shooterAndIntakeSub;

  public RunIntakeBackwardsCommand(ShooterAndIntakeSub shooterAndIntakeSub) {
  ...
  @Override
  public void execute() {
    m_shooterAndIntakeSub.setShooterMotor(-Constants.INTAKE_SPEED);
